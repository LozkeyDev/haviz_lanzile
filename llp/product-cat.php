                ...
                <form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" class="form-horizontal">
                    ...
                    <div class="col-lg-5 mt-4" style="margin-top: 30px;">
                        <div class="card" style="background-color: white; padding: 40px 40px 40px 40px">
                            <span style="color: darkgoldenrod; font-weight: bolder; font-family:'montserrat' , 'sans-serif';font-size: 16px; ">Add category </span>
                            <div class=" card-body card-block" style="margin-top: 10px">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-8">
                                        <input name="productcategory" id="productcategory" class="form-control" required>
                                ...
                                <div class="card-footer">
                                    <button type="submit" name="" id="upload" class="btn btn-primary btn-sm">
                                    ...
                                    <tbody id="">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo $row["ins_date"]; ?></td>
                                                <td><a href="?cat_id=<?php echo $encodeurl; ?>&&action=delete" class="btn btn-sm btn-danger">Delete</a></td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#upload").on("click", (err) => {
                ...
                if (category == "") {
                    $(".alert").addClass("alert-danger").slideDown().delay(1000).slideUp().html("Please enter category");
                } else {
                    $.ajax({
