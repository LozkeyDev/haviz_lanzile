        ...
        <div class="content-wrapper">
            ...
            <div class="row container">
                ...
                if (isset($_GET['id']) && isset($_GET['action'])) {
                    ...
                    if ($action == "delete") {
                        $sel = $conn->query("SELECT id FROM tbl_testimonial WHERE id = '$cat_id'");
                        if ($sel->num_rows == 0) {
                            echo message("danger", "Testimonial already deleted");
                        } else {
                            $del = $conn->query("DELETE FROM tbl_testimonial WHERE id = '$cat_id'");
                            if ($del) {
                                echo message("info", "You have successfully deleted a testimony");
                            }
                        }
                    }
                }
                ...
                if (isset($_POST['submit'])) {
                    $insTestimonial = array($_POST['fullname'], $_POST['testimony'], $_FILES['userPicture']);
                    uploadTestimonial($conn, $insTestimonial);
                }
                ?>
                <form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-5 mt-4" style="margin-top: 30px;">
                        <div class="card" style="background-color: white; padding: 40px 40px 40px 40px">
                            <span style="color: darkgoldenrod; font-weight: bolder; font-family:'montserrat' , 'sans-serif';font-size: 16px; ">Add Testimonial </span>
                            <div class=" card-body card-block" style="margin-top: 10px">


                                <div class="row form-group">
                                    <div class="col col-md-4">
                                        <label for="select" class=" form-control-label">Full Name <b style="color: red">*</b></label>
                                    </div>
                                ...
                                <div class="row form-group">
                                    <div class="col col-md-4">
                                        <label for="select" class=" form-control-label"> Testimonial <b style="color: red">*</b></label>
                                    </div>
                                    <div class="col-12 col-md-8">
                                        <textarea name="testimony" id="fullname" class="form-control" required></textarea>
                                    </div>
                                </div>

                                <div class="row form-group">
                                    <div class="col col-md-4">
                                        <label for="select" class=" form-control-label"> User Picture <b style="color: red">*</b></label>
                                    </div>
                                    <div class="col-12 col-md-8">
                                        <input type="file" name="userPicture" id="fullname" class="form-control" required accept=".jpeg, .jpg, .png">
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-7 mt-4" style="margin-top: 30px;">
                        <div class="card" style="background-color: white; padding: 40px 40px 40px 40px">
                            <span style="color: darkgoldenrod; font-weight: bolder; font-family:'montserrat' , 'sans-serif';font-size: 16px; "> View category </span>
                            <div class=" card-body card-block" style="margin-top: 10px">
                                    ...
                                    <tbody id="">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <div style="width: 100px; height: 100px; background-color: #f2f2f2; background-size: cover; background-position: center; background-repeat: no-repeat; background-image: url('product_image/<?php echo $row["userPicture"]; ?>');"></div>
                                                </td>
