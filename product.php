				...
				<div class="row" style="background-color: #F6F6F6;" style="padding: 20px 20px 20px 20px">
					<div class="col-lg-4" style="background: white;">
						<div class="owl-carousel owl-theme prod_pics magnific-gallery">
							<div class="item">
								<a href="img/products/shoes/product_detail_1.jpg" title="Photo title" data-effect="mfp-zoom-in">
									<img src="img/products/shoes/product_detail_1.jpg" alt=""></a>
							</div>
							<!-- /item -->
							<div class="item">
					...
					<div class="col-lg-5" style="background: white;">
						<div class="prod_info version_2">
							...
							<p><small>product name e.g Round neck </small><br>Little description Lorem ipsum dolor sit amet consectetur adipisicing elit. Temporibus optio itaque magnam aut. Illo earum minus assumenda velit eum delectus, laboriosam blanditiis ea minima commodi, animi, totam necessitatibus nisi eveniet!</p>
